...
.notas-wrap .tabla-scroll{{border:1px solid #dadce0;border-radius:12px;overflow:hidden}}
.notas-wrap .tabla-scroll table{{border-collapse:separate;border-spacing:0}}
